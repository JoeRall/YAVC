...
namespace YAVC.Base.Models
{
    public class VMList : AVM {
        ...
        private Data.Zone TheZone;

        public VMList(IController c): base(c)
        {

        }

        public VMList(VMMain MainVM, Data.Input input, Data.Zone TheZone) : base(MainVM.TheController)
        {
...
//            var result = await TheController.ListMenuUp(Input);
//            if (result.Success)
//            {
//                await Task.Run(() => EnsureMenuLayer(newLayer, 0));
//            }
//            else
//            {
//                UI.Invoke(() =>
...
//                cmd.SendAsync(TheController, result =>
//                {
//                    if (result.Success) {
